...
if (isset($role_id)) {
    ...
    if($all_ones == false){
        echo "<script>alert('Bạn không có quyền truy cập vào chức năng này!');window.location = 'tau.php';</script>";
    }
} else {
    echo "<script>alert('Bạn không có quyền truy cập vào chức năng này!');window.location = 'tau.php';</script>";
}
...
$list = $thongtin->timkiem($timkiem);
$kinhnghiem = $thongtin->selectKinhNghiemDiTau();
$truonghoc = $thongtin->selectTruongHoc();
$nguoithan = $thongtin->selectNguoiThan();
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['delete'])) {
        ...
        if ($result2) {
            ...
            echo '<script type="text/javascript">alert("Xóa thất bại! Thuyền viên còn liên quan thông tin khác.");window.location.href = "index.php";</script>';
...
<div>
    ...
    <div style="margin-top: 20px;margin-bottom: 20px;">
        ...
        <form style="display: inline; " action="timkiem.php" method="POST">
        ...
        <form style="display: inline; " name="form1" id="form1" action="loc.php" method="GET">
            <select style="color: gray;margin-left: 20px;font-size: 17px;" name="subject" id="subject">
            ...
            <select style="color: gray;margin-left: 20px;font-size: 17px;" name="topic" id="topic">
            ...
            <select style="color: gray;margin-left: 20px;font-size: 17px;" name="chapter" id="chapter">
            ...
            <input style="margin-left: 20px;font-size: 17px;" type="submit" value="Lọc">
        </form>
    </div>
    <div id="tableSection">
        <h3>Danh sách tất cả thuyền viên</h3>
    ...
    <div>
        <div class="tab">
            <button class="tablinks" onclick="openCity(event, 'thongtinchitiet')">Thông tin chi tiết</button>
            ...
            <div style="display: flex; align-items: flex-start;">
                ...
                <table style="border: none;display: flex; ">
                    <tr>
                        ...
                        <td><label class="lbchitiet ">Chức danh hiện tại:</label><br>
...
<div id="myFormthemnguoithan">
    ...
    <form id="myForm" action="index.php" method="post" enctype="multipart/form-data" onsubmit="normalizeName()">
...
<div id="myFormsuanguoithan">
    ...
    <form id="myForm" action="index.php" method="post" enctype="multipart/form-data" onsubmit="normalizeName2()">
...
<script>
    ...
    function showDetail(row) {
        ...
        document.getElementById("chucdanh").value = detail.chucdanh;
