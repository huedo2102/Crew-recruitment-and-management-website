<div class="col-lg-4 col-md-4 col-sm-4">
        <div class="latest_post">
          ...
          <div class="latest_post_container" style="height:500p; overflow: auto;">
            ...
            $latest = "SELECT * FROM baiviet ORDER BY RAND() DESC LIMIT 10";
            ...
            if($latest_n){
              while( $rows = mysqli_fetch_assoc($latest_n) ){
                ...
                ?>
                <li>
                <div class="media"> <a href="read-post.php?id=<?php echo $id; ?>" class="media-left"> 
                <?php
                if (!empty($img)) {
                    echo '<img alt="" src="./upload/thumbnail/' . htmlspecialchars($img, ENT_QUOTES, 'UTF-8') . '">';
                }else {
                    $default_img = '661e103226e768.11335933.jpg';
                    echo '<img alt="" src="./upload/thumbnail/' . htmlspecialchars($default_img, ENT_QUOTES, 'UTF-8') . '">';
                }
                ?>
              </a>
        ...
        <div class="latest_post">
            ...
            <!-- ADDING POPULAR NEWS --------------------------------------------------------------->
            <?php 
                $latest = "SELECT * FROM baiviet ORDER BY thoigian DESC LIMIT 10";
                $latest_n = mysqli_query($conn , $latest);
                if($latest_n){
